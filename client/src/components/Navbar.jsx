...
export default function Navbar() {
  ...
  return (
    <nav className="bg-[#0000FF] text-white shadow-lg">
              ...
              <>
                {user.role === 'admin' && (
                  <div className="flex gap-3 text-sm">
                    ...
                    <Link to="/admin/books" className="hover:text-blue-200">Books</Link>
                ...
                <span className="text-sm text-blue-200 ml-4">{user.name}</span>
                <button onClick={handleLogout} className="text-sm bg-[#0000FF] px-3 py-1 rounded hover:bg-[#0000DD]">
                  Logout
                </button>
              </>
            ) : (
