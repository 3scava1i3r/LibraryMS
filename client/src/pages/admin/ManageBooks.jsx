          ...
          <tbody className="divide-y">
            {books.map(b => (
              <tr key={b.id} className="hover:bg-gray-50">
                ...
                <td className="p-4"><span className="text-xs bg-indigo-100 text-indigo-700 px-2 py-1 rounded">{b.category}</span></td>
                ...
                <td className="p-4 text-center">
                  <button onClick={() => openEdit(b)} className="text-indigo-600 hover:underline mr-3">Edit</button>
          ...
          <div className="bg-white rounded-xl p-6 w-full max-w-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <div className="flex gap-3 pt-2">
                <button type="submit" className="flex-1 bg-indigo-600 text-white py-2 rounded-lg hover:bg-indigo-700">{editBook ? 'Update' : 'Create'}</button>
